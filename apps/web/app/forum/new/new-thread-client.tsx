    ...
    <Card>
      ...
      >
        ...
        <FormField id="category" label="Kategori">
          <select
            className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
            value={categoryId}
        ...
        <FormField id="body" label="İçerik">
          <textarea
            ...
            className="w-full rounded-lg border border-slate-300 bg-white p-3 text-slate-900 placeholder:text-slate-400 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500"
          />
        </FormField>
      ...
      {createThread.isError && (
        <InlineAlert
          className="mt-3"
          variant="error"
          message={resolveFeedbackErrorMessage(createThread.error)}
        />
      )}
    </Card>
  );
